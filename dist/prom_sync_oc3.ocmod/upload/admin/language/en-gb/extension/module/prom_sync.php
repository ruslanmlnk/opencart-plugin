...
$_['text_import_error'] = 'Import error, check log.';
$_['text_fix_seo_success'] = 'Success: Fixed %d SEO URL records.';
$_['text_section_main'] = 'Main Settings';
$_['text_section_import'] = 'Product Import';
$_['text_section_mapping'] = 'Mapping & Categories';
$_['text_section_sync'] = 'Synchronization Settings';
$_['text_section_sync_fields'] = 'Fields to Update (Sync FROM Prom)';
$_['text_section_actions'] = 'Actions';
$_['help_sync_fields'] = 'Choose which fields should be automatically updated in OpenCart when they change on Prom.ua.';
$_['text_section_cron'] = 'Automation (Cron)';
$_['text_section_logs'] = 'Module Logs';
$_['text_section_tools'] = 'Tools & Maintenance';
...
$_['entry_cron_url'] = 'Cron URL (Orders Sync)';
$_['entry_cron_url_inventory'] = 'Cron URL (Inventory Sync)';
$_['entry_fix_seo'] = 'Repair SEO URLs';
$_['button_fix_seo'] = 'Fix Duplicates';
$_['help_fix_seo'] = 'Add language prefixes (uk-, ru-) to SEO URLs if they are identical or conflict with other products.';
